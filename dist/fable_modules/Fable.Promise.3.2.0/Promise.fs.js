...
import { Result_MapError, Result_Map, FSharpResult$2 } from "../fable-library-js.5.7.0/Result.js";
import { class_type } from "../fable-library-js.5.7.0/Reflection.js";
import { disposeSafe, getEnumerator } from "../fable-library-js.5.7.0/Util.js";
import { Operators_IsNull } from "../fable-library-js.5.7.0/FSharp.Core.js";
...
export function result(a) {
    return a.then((ResultValue) => (new FSharpResult$2(/* Ok */ 0, [ResultValue]))).catch((ErrorValue) => (new FSharpResult$2(/* Error */ 1, [ErrorValue])));
}
...
export function bindResult(fn, a) {
    return a.then((a_1) => {
        if (a_1.tag === 1) {
            return Promise.resolve(new FSharpResult$2(/* Error */ 1, [a_1.fields[0]]));
        }
        else {
            const pr = fn(a_1.fields[0]);
            return pr.then((ResultValue) => (new FSharpResult$2(/* Ok */ 0, [ResultValue])));
        }
    });
}
